...
import com.oreilly.mrdp.ch6.JobChainingDriver.UserIdBinningMapper;
import com.oreilly.mrdp.ch6.JobChainingDriver.UserIdCountMapper;
import com.oreilly.mrdp.ch6.JobChainingDriver.UserIdSumReducer;
import com.oreilly.mrdp.ch6.ParallelJobs.AverageReputationMapper;
...
public class JobControlDriver {
  public static void main(String[] args) throws Exception {
    ...
    if (countingJob.waitForCompletion(true)) {
      ControlledJob binningControlledJob = new ControlledJob(getBinningJobConf(
          countingJob, countingOutput, userInput, binningOutputRoot));
  ...
  public static Configuration getBinningJobConf(Job countingJob,
    ...
    // Setup binning job
    Job binningJob = Job
        .getInstance(new Configuration(), "JobChaining-Binning");
    ...
    MultipleOutputs.addNamedOutput(binningJob,
        JobChainingDriver.MULTIPLE_OUTPUTS_BELOW_NAME, TextOutputFormat.class,
        Text.class, Text.class);

    MultipleOutputs.addNamedOutput(binningJob,
        JobChainingDriver.MULTIPLE_OUTPUTS_ABOVE_NAME, TextOutputFormat.class,
        Text.class, Text.class);
    ...
    FileStatus[] userFiles = FileSystem.get(new Configuration()).listStatus(
        userInput);
